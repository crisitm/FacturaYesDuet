...
.constant('DEFAULT_LOGO', 'images/yesduet.png')
...
.constant('DEFAULT_INVOICE', {
  ...
  customer_info: {
    name: 'Cisne',
    web_link: 'cisnedepiedra.com.',
    address1: 'Grecia, Alajuela',
    address2: 'Costa Rica',
    postal: '90210'
  },
  company_info: {
    name: 'Yes Duet',
    web_link: 'www.yesduet.com',
    address1: 'San Roque, Grecia, Alajuela',
    address2: 'Alajuela, Costa Rica',
    postal: '10203'
  },
  items:[
    { qty: 10, description: 'ítem', cost: 9.95 }
  ]
})
...
.controller('InvoiceCtrl', ['$scope', '$http', 'DEFAULT_INVOICE', 'DEFAULT_LOGO', 'LocalStorage', 'Currency',
  ...
  $scope.clearLocalStorage = function() {
    var confirmClear = confirm('seguro que desea cancelar el proceso de facturación?');
    if(confirmClear) {
      LocalStorage.clear();
